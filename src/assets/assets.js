...
export const cities = [
    "Single Umra (First Arrival Makkah)",
    "Single Umra (First Arrival Madina)",
    "2 Umra Package",
    "Makkah Only",
    "Madina Only",
];
...
export const testimonials = [
    ...
    { id: 4, name: "Sophia Lee", address: "Seoul, South Korea", image: "https://images.unsplash.com/photo-1701615004837-40d8573b6652?q=80&w=200", rating: 5, review: "Amazing service! I always find the best luxury accommodations through QuickStay. Their recommendations never disappoint!" },
